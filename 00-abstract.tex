\begin{abstract}
Random Number Generators are a critical part of cryptographic algorithms as well as financial simulations, in which lack of randomness results in inaccurate results which can cause very high costs. Thus test suites to evaluate the randomness of such generators are critical.
